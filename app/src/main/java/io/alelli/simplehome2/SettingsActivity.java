    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(fab != null) {
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View view) {
                    ...
                    // CAM
                    final RadioButton metodoCamRadioHTTP = (RadioButton) layout.findViewById(R.id.dialog_profilo_cam_metodo_http);
                    final RadioButton metodoCamRadioHTTPS = (RadioButton) layout.findViewById(R.id.dialog_profilo_cam_metodo_https);
                    final EditText urlCamEditText = (EditText) layout.findViewById(R.id.dialog_profilo_cam_url);
                    final EditText usernameCamEditText = (EditText) layout.findViewById(R.id.dialog_profilo_cam_username);
                    final EditText passwordCamEditText = (EditText) layout.findViewById(R.id.dialog_profilo_cam_password);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapter, View v, int position, long arg3) {
                ...
                // CAM
                final TextView urlCamTextView = (TextView) layout.findViewById(R.id.dialog_info_profilo_cam_url);
                urlCamTextView.setText(profilo.getUrlCam());
                final TextView usernameCamTextView = (TextView) layout.findViewById(R.id.dialog_info_profilo_cam_username);
                usernameCamTextView.setText(profilo.getUsernameCam());
